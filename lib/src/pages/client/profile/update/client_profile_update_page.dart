...
import 'package:flutter_app_delivery/src/pages/client/profile/update/client_profile_update_controller.dart';
import 'package:get/get.dart';
// ignore: must_be_immutable
class ClientProfileUpdatePage extends StatelessWidget {

  ClientProfileUpdaterController con = Get.put(ClientProfileUpdaterController());
    ...
    return SafeArea(
      child: Container(
        ...
        child: GestureDetector(
          ...
          child: GetBuilder<ClientProfileUpdaterController>(
